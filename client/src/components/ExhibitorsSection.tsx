...
export default function ExhibitorsSection() {
  ...
  const exhibitors: Exhibitor[] = [
    ...
    { name: "NLPC Bốn Phương", description: "Phân phối độc quyền miền Bắc: WAO, No.1, SG, Vạn Thành, LongBeach — nguồn gốc rõ ràng, giá hợp lý, sản lượng ổn định. Nguyên liệu đầy đủ, công thức liên tục cập nhật. Chiết khấu cao, trả thưởng hấp dẫn. Nhượng quyền \"3 Không\" và hỗ trợ setup quán từ A–Z.", products: ["Nguyên liệu pha chế đa dạng", "Siro & Topping", "Giải pháp nguyên liệu trọn gói"], image: "/nlpc_b_n_ph__ng.png" },
    ...
    { name: "Minh Hạnh Food", description: "Minh Hạnh Food & IQ Food — hơn 20 năm dẫn đầu thị trường nguyên liệu pha chế Việt Nam với 70% thị phần bán buôn. Nổi bật với topping chất lượng cao: trân châu Kun Han, Sea 3Q, thạch, nha đam, siro Tomoxi và trà sữa uống liền IQ Food. 4 nhà máy chuẩn ISO 22000, ứng dụng công nghệ hiện đại từ nông sản nội địa. Cam kết đồng hành cùng nông dân và mang sản phẩm tốt với \"giá cho người Việt\".", products: ["Nguyên liệu thực phẩm F&B", "Sản phẩm pha chế", "Giải pháp nguyên liệu cho quán"], image: "/minh_h_nh_food.png" },
