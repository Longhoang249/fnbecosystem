...
export default function ExhibitorsSection() {
  ...
  useEffect(() => {
    const handleSelect = (e: any) => {
      ...
      else if (brandName.includes("VBM") || brandName.includes("KK GROUP")) matchIndex = 9;
