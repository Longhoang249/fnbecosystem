...
export default function ExhibitorsSection() {
  ...
  const exhibitors: Exhibitor[] = [
    ...
    { name: "Boduo", description: "Thương hiệu nguyên liệu pha chế chất lượng cao dành cho ngành F&B.", products: ["Nguyên liệu pha chế cao cấp", "Giải pháp đồ uống sáng tạo"], image: "https://placehold.co/600x400/1B4332/D4A853?text=BODUO" },
