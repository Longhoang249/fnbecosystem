...
export default function ExhibitorsSection() {
  ...
  useEffect(() => {
    const handleSelect = (e: any) => {
      ...
      else if (brandName.includes("Cốc Giấy") || brandName.includes("KK GROUP")) matchIndex = 7;
